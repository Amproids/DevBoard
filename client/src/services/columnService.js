...
export const columnService = {
    ...
    async getColumns(boardId, params = {}) {
        try {
            const response = await axios.get(`${API_BASE_URL}/columns/${boardId}`, {
                ...getAuthHeaders(),
    ...
    async createColumn(boardId, columnData) {
        try {
            const response = await axios.post(`${API_BASE_URL}/columns/${boardId}`, columnData, getAuthHeaders());
            return response.data;
        } catch (error) {
    ...
    async updateColumn(columnId, columnData) {
        try {
            const response = await axios.put(`${API_BASE_URL}/columns/${columnId}`, columnData, getAuthHeaders());
            return response.data;
        } catch (error) {
    ...
    async toggleColumnLock(columnId, isLocked) {
        try {
            const response = await axios.patch(`${API_BASE_URL}/columns/${columnId}`, 
                { isLocked }, 
                getAuthHeaders()
            );
            return response.data;
