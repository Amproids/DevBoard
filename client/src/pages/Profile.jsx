            ...
            <div className="px-4 sm:px-6 lg:px-8 py-12">
                ...
                {loading && (
                    <div className="flex justify-center items-center h-screen">
                        <div className="animate-spin rounded-full h-16 w-16 border-b-4 border-[var(--color-secondary)]"></div>
                    </div>
                )}
                ...
                {status.message && (
                    <div
                        className={`mb-8 p-4 rounded-lg shadow-sm ${status.success ? 'bg-green-50 text-green-800 border border-green-200' : 'bg-red-50 text-red-800 border border-red-200'}`}
                    >
                    ...
                    <>
                        ...
                        <div className="max-w-7xl mx-auto space-y-8">
                            ...
                            <div className="bg-white rounded-lg shadow-md border border-gray-500 overflow-hidden">
                                ...
                                <div className="p-6">
                                    <LinkedAccounts
                                        onAccountsUpdate={handleProfileUpdate}
                                    />
                                </div>
                            </div>
