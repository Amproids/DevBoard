        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-4">
            <p className="text-lg text-gray-700 leading-relaxed">
              <strong className="text-[var(--color-secondary)] font-semibold">Frontend:</strong> 
              <span className="ml-2">React, Socket.io, React DnD, Tailwind CSS</span>
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              <strong className="text-[var(--color-secondary)] font-semibold">Backend:</strong> 
              <span className="ml-2">Node.js, Express, MongoDB, Socket.io</span>
            </p>
          </div>
        </div>
      </section>
